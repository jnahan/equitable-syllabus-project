      ...
      <div className="section">
        <div className="section__content">
          <div className="section__text">
            ...
            <p className="body-large">Recommend resources to our database by filling out our resource recommendation form. Your contributions will assist ITP/IMA faculty in creating more equitable syllabi!</p>
